...
"""
python sweep.py --n_envs 1 --output_dir test_results/1envs --d 0
python sweep.py --n_envs 3 --output_dir test_results/3envs --d 0 
python sweep.py --n_envs 6 --output_dir test_results/6envs --d 0
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_model_seeds', type=int, default=3)

...
def run_experiment(args, device='cpu'):
    ...
    utils.set_seed(args["model_seed"]) # 100 10000
    ...
    if args["model"] == 'IIB':
        model.set_scramble(dataset.scramble)
        model.set_dim_inv(dataset.dim_inv)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default="IIB")
    parser.add_argument('--num_iterations', type=int, default=10000)
    parser.add_argument('--hparams', type=str, default="default")
    parser.add_argument('--dataset', type=str, default="ExampleMy2")
